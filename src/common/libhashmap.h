...
#define LIBHASHMAP_VERSION "0.0.1"
...
const void* hashmap_del(struct hashmap* map, const void* item);
...
const void* hashmap_del_with_hash(struct hashmap* map, const void* key, uint64_t hash);
