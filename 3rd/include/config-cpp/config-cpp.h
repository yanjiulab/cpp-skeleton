...
class ConfigCpp {
  public:
    ...
    /**
     * @brief Explicit set the Config type
     *
     * @param name - configuration type, default is choosing by file extension
     */
    ...
    /**
     * @brief Return the Config file used
     *
     * @return std::string - Configuration file name
     */
    std::string ConfigFileUsed() const;
    ...
    void SetBool(const std::string &key, const bool &boolVal);
    ...
    void SetString(const std::string &key, const char *stringVal);
    ...
    bool WriteConfig();
    // bool SafeWriteConfig() const;
    // bool WriteConfigAs(const std::string &filename) const;
    // bool SafeWriteConfigAs(const std::string &filename) const;
...
#include "config-cpp/detail/config-cpp-inl.h"